<section>
	...
	{IF({ISSET:errorEmailMismatch})}
		<div class="messege message--error">
	...
	<form action="{PAGEURL}" method="post" accept-charset="utf-8">
		...
		<fieldset>
			...
			<div>
				...
				<input id="sellerEmail" type="text" value="{VAR:sellerId}" name="sellerId" />
			</div>

			<div class="form-field">
				<label for="sellerEmail">E-Mail-Adressen mit der Sie die Verkäufer-Nr. registriert haben (zum Abgleich)</label>
		...
		<fieldset>
			<div class="form-field">
				<input value="amount_50" type="number" min="0" max="50" value="{IF({ISSET:amount_50:VAR})}{VAR:amount_50}{ELSE}3{ENDIF}" name="amount_50" id="amount_50">
