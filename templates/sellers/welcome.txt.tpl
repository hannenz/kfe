...
Abgabe   am {DATEFMT:"{VAR:market_submission_begin}":"%d.%B %Y":de_DE.utf-8} von {DATEFMT:"{VAR:market_submission_begin}":"%H:%M"} bis {DATEFMT:"{VAR:market_submission_end}":"%H:%M"} Uhr
Abholung am {DATEFMT:"{VAR:market_pickup_begin}":"%d.%B %Y":de_DE.utf-8}     von {DATEFMT:"{VAR:market_pickup_begin}":"%H:%M"}     bis {DATEFMT:"{VAR:market_pickup_end}":"%H:%M"} Uhr

Wir wünschen dir viel Freude und Erfolg beim Verkauf!
Für weitere Rückfragen stehen wir dir gerne unter <info@kinderflohmarkt-erbach.de> oder Tel. 07305 / 93 99 97 3 zur Verfügung. (Nachrichten auf Anrufbeantworter)
